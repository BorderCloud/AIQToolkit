...
const Home = (props: any) => {
  ...
  useEffect(() => {
    if (window.innerWidth < 640) {
      ...
      dispatch({ field: 'showMemorybar', value: false });
    }
  ...
  useEffect(() => {
    ...
    const showMemorybar = sessionStorage.getItem('showMemorybar');
    if (showMemorybar) {
      dispatch({ field: 'showMemorybar', value: showMemorybar === 'true' });
    }
  ...
  return (
    ...
    >
      <Head>
        ...
        />
        <link rel="icon" href="/favicon_eccenca.svg" />
      </Head>
      {selectedConversation && (
        <main
